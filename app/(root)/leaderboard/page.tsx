    ...
    <div className="p-6 w-full mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {["multiple choice", "true/false", "verbal"].map((typeLabel, index) => {
          ...
          return (
            <div key={typeLabel} className={`flex-1 p-6 rounded-3xl shadow-2xl ${columnGradients[index]}`}>
                        ...
                        {q.topScorers.slice(0, 3).map((s, i) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className={`px-3 py-1 rounded-full text-white font-bold text-sm ${rankColors[i]} shadow-lg`}>
                                {s.score}
                              </div>
                            </li>
                          );
