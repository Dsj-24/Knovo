        ...
        <>
          <LoadingOverlay 
            ...
            <div className='call-view mb-6'>
                ...
                <div className="card-border rounded-4xl bg-gradient-to-br from-purple-800/20 to-blue-800/20 border-2 border-purple-400/30">
                            ...
                            {isSpeaking && (
                                <>
                                    <div className="flex items-center gap-2 bg-emerald-500/20 px-3 py-1 rounded-full border border-emerald-500/30">
                                        ...
                                        <span className="text-emerald-300 text-sm font-medium">Listening</span>
                                    </div>
                            ...
                            <div className="space-y-3">
                                {messages.map((m, i) => (
                                    ...
                                    >
                                        ...
                                        <div className="text-white leading-relaxed">{m.content}</div>
                                    </div>
                                ))}
                            </div>
                        )}
